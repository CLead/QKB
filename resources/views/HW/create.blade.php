				...
				<div class="card  grey darken-1 Control-Item">
					...
					<div class="card-body grey lighten-3">
						<div id="dataarea" class="row wrapper">
							<h3 class="OrangeFont">Create New Company</h3>

						<form method="POST" action="{{route('CompanyNew')}}">
							<div class="row">

								{{ csrf_field() }}

								<div class="col l6 s12 m6 input-field ">
									<input name="CompanyName" id="CompanyName" type="text" class="validate" value="{{old('CompanyName')}}" required>
									<label for="CompanyName">Company Name</label>
								</div>

								<div class="col l6 s12 m6 input-field ">
									<label for="CompanyCode">Account Code</label>
									<input name="CompanyCode" id="CompanyCode" type="text" class="validate" value="{{old('CompanyCode')}}" required>
								</div>
							...
							<div class="row">
								<div class="col l6 s12 m6 input-field ">
									<div class="input-field col s6">
										...
										<input name="RegistrationCode" id="RegistrationCode" type="text" class="validate" value="{{old('RegistrationCode')}}" required>
									</div>
									<div class="input-field col s6">
								...
								<div class="col l6 s12 m6 input-field ">
									...
									<input name="AdminEmail" id="AdminEmail" type="text" class="validate" value="{{old('AdminEmail')}}" required>
								</div>
