...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ URL::asset('css/default.css') }}?t=1">
    ...
    <div class="navbar-fixed">
        <nav class="teal lighten-2">
            <div class="nav-wrapper">
                ...
                <a id="button-collapse" href="#" data-activates="slide-out" class="sidebar-collapse btn-floating btn-medium waves-effect waves-light hide-on-large-only button-collapse cyan"><i class="material-icons">menu</i></a>
