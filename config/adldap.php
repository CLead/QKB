            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'account_suffix' => env('ADLDAP_ACCOUNT_SUFFIX', '@quad.local'),
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'QUADEXCHANGE.quad.local QUAD2000.quad.local')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'OU=Users Standard,DC=quad,DC=local'),
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'carl'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'pythoN'),
